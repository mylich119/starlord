...
class User extends Base
{
    ...
    public function config()
    {
        ...
        $config = array(
            ...
            'docoment' => array(
                'share_description' => '汇总本群内信息,格式更规范,群外可搜索,成功率更高',            //分享小卡片上的描述语句
                'notice_list' => array(
                    '以下列表中的群和你的微信拼车群一一对应',
                    '转发行程到微信拼车群后，不要忘记在群内【点击你的分享】，将行程加入拼车群管家',
                ),                //拼车群tab上的公告
                'group_page_info' => '通过本小程序发布分享你的行程到微信拼车群，自动汇总到以上列表',
                ...
                'first_publish_alert' => '转发行程到微信拼车群后，不要忘记在群内【点击你的分享】',        //发布首页下面的说明文字
                'publish_finish_tip' => '需要再次分享该行程，在【我的】->【我的行程】中查找，不用重新创建',        //发布完成返回按钮下的文案
                'share_tip' => '转发行程到微信拼车群后，不要忘记在群内【点击你的分享】，将行程加入拼车群管家',    //发布到拼车群按钮下的文案
