...
class User extends Base
{
    ...
    public function config()
    {
        ...
        $config = array(
            ...
            'docoment' => array(
                'share_description' => '自动汇总本群内信息,格式更规范,群内群外可搜索',            //分享小卡片上的描述语句
                'notice_list' => array(
                    '以下列表中的群和你的拼车群一一对应',
                ...
                'first_publish_alert' => '发布行程到拼车群后，【点击你的分享】，将行程加入拼车群管家',        //发布首页下面的说明文字
                'publish_finish_tip' => '已发布的行程，如果需要再次分享，在【我的】->【我的行程】中查找',        //发布完成返回按钮下的文案
                'share_tip' => '转发行程到拼车群后，不要忘记在【群内点击】你的分享，将行程加入拼车群管家',    //发布到拼车群按钮下的文案
